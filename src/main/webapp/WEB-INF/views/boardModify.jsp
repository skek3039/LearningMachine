		...
		<div id="content">
				...
				<form action="./boardModify.do" method="Post">
					<table class="table" style="width: 90%; height:100%; margin: 0 auto" >						 
						    <tr>
						      <th style="width: 100px;"><input type="text" name="b_title" required="required"  placeholder="${board.b_title }" style="width: 100%"> </th>
						    </tr>
						 	<tr>
						 		<td>	<textarea class="summernote" id="b_content" name="b_content" required="required" style="height: 150px; resize: none; z-index: 1100;">${board.b_content }</textarea></td>
						 		
						 	</tr>
						 	<tr>		
						 		<td>
						 		<input type="hidden" name = "b_no" value="${board.b_no }">
						 		<button type="submit" class ="btn btn-outline-dark" style="width: 100%;">수정</button></td>
							</tr>
						</table>
				</form>	
			</div>			
