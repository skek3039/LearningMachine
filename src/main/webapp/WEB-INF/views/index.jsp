...
<body>
	...
	<jsp:include page="./header2.jsp"/>
        ...
        <div class="container-xxl py-6">
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s" style="border-color : #00B98E">
...
너무 비싸서, 거리가 멀어서.. 여러 이유로 당연하다고 생각되어 지는것들이 어떤 누군가에게는 사치가 되기도 합니다. 그런 현실에 도전하려 합니다.<br> <strong>러닝머신</strong>은 누구나, 경제적으로 시간적 제약없이 내가 원하는 것을 배우고, 지식을 나눌 수 있는 공간입니다.</p>
                    ...
                    <div class="col-lg-7">
                        <div class="row g-5">
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s" style="border-radius:10px; background-color : #F0FFF0">
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s" style="border-radius:10px; background-color : #F0FFF0">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="flex-shrink-0 btn-square bg-primary rounded-circle me-3">
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s" style="border-radius:10px; background-color : #F0FFF0">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="flex-shrink-0 btn-square bg-primary rounded-circle me-3">
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s" style="border-radius:10px; background-color : #F0FFF0">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="flex-shrink-0 btn-square bg-primary rounded-circle me-3">
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s" style="border-radius:10px; background-color : #F0FFF0">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="flex-shrink-0 btn-square bg-primary rounded-circle me-3">
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.6s" style="border-radius:10px; background-color : #F0FFF0">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="flex-shrink-0 btn-square bg-primary rounded-circle me-3">
